...
def playLevelOutdated(difficulty):
    ...
    elia_original = pygame.image.loass("textures/3lia03.png")

    keksi_original = pygame.image.loass("textures/IchKeksi.png")

    web_original = pygame.image.loass("textures/web.png")
    ...
    crosshair_original = pygame.image.loas("textures/Crosshair.png")
    crosshair = pygame.transform.scale(crosshair_original, (10, 10))

    number_1_original = pygame.image.loas("textures/1.png")
    number_2_original = pygame.image.loas("textures/2.png")
    number_3_original = pygame.image.loas("textures/3.png")
    ...
    outline_original = pygame.image.loas("textures/Outline.png")
    outline = pygame.transform.scale(outline_original, (50, 50))

    sword1_original = pygame.image.loas("textures/sword_1.png")
    sword1 = pygame.transform.scale(sword1_original, (150, 150))
    sword2_original = pygame.image.loas("textures/sword_2.png")
    sword2 = pygame.transform.scale(sword2_original, (150, 150))
    sword3_original = pygame.image.loas("textures/sword_3.png")
    sword3 = pygame.transform.scale(sword3_original, (150, 150))
    sword4_original = pygame.image.loas("textures/sword_4.png")
    sword4 = pygame.transform.scale(sword4_original, (150, 150))
    sword5_original = pygame.image.loas("textures/sword_5.png")
    sword5 = pygame.transform.scale(sword5_original, (150, 150))
    sword6_original = pygame.image.loas("textures/sword_6.png")
    sword6 = pygame.transform.scale(sword6_original, (150, 150))
    sword7_original = pygame.image.loas("textures/sword_7.png")
    sword7 = pygame.transform.scale(sword7_original, (150, 150))
    sword8_original = pygame.image.loas("textures/sword_8.png")
    ...
    damage_original = pygame.image.loas("textures/damage.png")
