...
broken_heart_texture = pygame.image.load(tex_dir + "broken_heart.png").convert_alpha()
chest_texture = pygame.image.load(tex_dir + "chest.png").convert_alpha()
cobblestone_texture = pygame.image.load(tex_dir + "cobblestone.png").convert_alpha()
cross_texture = pygame.image.load(tex_dir + "cross.png").convert_alpha()
crosshair_texture = pygame.image.load(tex_dir + "crosshair.png").convert_alpha()
dagger_texture = pygame.image.load(tex_dir + "dagger.png").convert_alpha()
damage_texture = pygame.image.load(tex_dir + "damage.png").convert_alpha()
damage_player_texture = pygame.image.load(tex_dir + "damage_player.png").convert_alpha()
defeat_texture = pygame.image.load(tex_dir + "defeat.png").convert_alpha()
empty_texture = pygame.image.load(tex_dir + "empty.png").convert_alpha()
gui_background_texture = pygame.image.load(tex_dir + "gui_background.png").convert_alpha()
gui_template_texture = pygame.image.load(tex_dir + "gui_template.png").convert_alpha()
heart_texture = pygame.image.load(tex_dir + "heart.png").convert_alpha()
ichkeksi_texture = pygame.image.load(tex_dir + "ichkeksi.png").convert_alpha()
icon_texture = pygame.image.load(tex_dir + "icon.png").convert_alpha()
icon_big_texture = pygame.image.load(tex_dir + "icon_big.png").convert_alpha()
lava_texture = pygame.image.load(tex_dir + "lava.png").convert_alpha()
level_selection_texture = pygame.image.load(tex_dir + "level_selection.png").convert_alpha()
logo_texture = pygame.image.load(tex_dir + "logo.png").convert_alpha()
menu_texture = pygame.image.load(tex_dir + "menu.png").convert_alpha()
menu_mode_1_texture = pygame.image.load(tex_dir + "menu_mode_1.png").convert_alpha()
menu_mode_2_texture = pygame.image.load(tex_dir + "menu_mode_2.png").convert_alpha()
menu_mode_3_texture = pygame.image.load(tex_dir + "menu_mode_3.png").convert_alpha()
mud_texture = pygame.image.load(tex_dir + "mud.png").convert_alpha()
outline_texture = pygame.image.load(tex_dir + "outline.png").convert_alpha()
overlay_texture = pygame.image.load(tex_dir + "overlay.png").convert_alpha()
pause_menu_texture = pygame.image.load(tex_dir + "pause_menu.png").convert_alpha()
rande_texture = pygame.image.load(tex_dir + "rande.png").convert_alpha()
sandstone_texture = pygame.image.load(tex_dir + "sandstone.png").convert_alpha()
selection_texture = pygame.image.load(tex_dir + "selection.png").convert_alpha()
settings_menu_texture = pygame.image.load(tex_dir + "settings_menu.png").convert_alpha()
shuriken_texture = pygame.image.load(tex_dir + "shuriken.png").convert_alpha()
tick_texture = pygame.image.load(tex_dir + "tick.png").convert_alpha()
title_screen_texture = pygame.image.load(tex_dir + "title_screen.png").convert_alpha()
victory_texture = pygame.image.load(tex_dir + "victory.png").convert_alpha()
wall_texture = pygame.image.load(tex_dir + "wall.png").convert_alpha()
web_texture = pygame.image.load(tex_dir + "web.png").convert_alpha()
wert32_texture = pygame.image.load(tex_dir + "wert32.png").convert_alpha()
